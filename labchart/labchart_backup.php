<?php		
	session_start();
        ...
        $debugging = false; # Cambia la fuente de datos. False: consulta en la DB del hospital. True: usa los datos de carpeta mock_data
        if ($debugging) {
...
$array_final = json_encode(array_values($estudios_analizados_formateados));
echo $array_final;
